 ...
 <ul>
  <li>
   <dl>
    ...
    <dd><a href="CarServlet?method=uptate">修改二手车</a></dd>
   </dl>
  </li>
  <li>
   <dl>
...
<section class="rt_wrap content mCustomScrollbar">
 <div class="rt_content">
     ...
     <section>
     <form method="post" action="CarServlet?method=add">
      <ul class="ulColumn2">
       <li>
        <span class="item_name" style="width:120px;">平牌名</span>
        <input type="text" name="pinpaiming" class="textbox" placeholder="平牌名"/>
        
       </li>
       <li>
        <span class="item_name" style="width:120px;">系列</span>
        <input type="text" name="xilie" class="textbox" placeholder="系列"/>
        
       </li>
       <li>
        <span class="item_name" style="width:120px;">公里数</span>
        <input type="text" name="gonglishu" class="textbox" placeholder="公里数"/>
        
       </li>
       
       <li>
        <span class="item_name" style="width:120px;">颜色</span>
        <input type="text" name="yanse" class="textbox" placeholder="颜色"/>
        
       </li>
        <li>
        <span class="item_name" style="width:120px;">售价</span>
        <input type="text" name="shoujia" class="textbox" placeholder="售价"/>
        
       </li>
       <input type="submit" value="提交" class="group_btn"/>
       </form>
      </ul>
     </section>
 </div>
